...
function(python_add_test)
  ...
  # if(IS_ABSOLUTE ${CMAKE_INSTALL_PYTHONDIR})
  #   set(PREPENDPYPATH ${CMAKE_INSTALL_PYTHONDIR})
  # else()
  #   set(PREPENDPYPATH "${ADIOS2_BINARY_DIR}/${CMAKE_INSTALL_PYTHONDIR}")
  # endif()
  # set_property(TEST ${ARGS_NAME} PROPERTY
  #   ENVIRONMENT "PYTHONPATH=${PREPENDPYPATH}:$ENV{PYTHONPATH}"
  # )
  set_property(TEST ${ARGS_NAME} PROPERTY
