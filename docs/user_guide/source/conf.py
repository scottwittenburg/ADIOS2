# -*- coding: utf-8 -*-
#
# ADIOS2 documentation build configuration file, created by
...
exclude_patterns = [
    ...
    "setting_up/source/fortran.rst",
    "setting_up/source/python.rst",
    "setting_up/source/examples.rst",
    "setting_up/source/cmake.rst",
    "setting_up/source/hpc_systems.rst",
    "setting_up/source/ctest.rst",
    "setting_up/source/cpp_c.rst",
    "setting_up/doemachines.rst",
    ...
    "components/variable.rst",
    "components/engine.rst",
    "components/operator.rst",
    "components/runtime.rst",
    "components/attribute.rst",
    "components/io.rst",
...
latex_documents = [
    (master_doc, "ADIOS2.tex", "ADIOS2 Documentation", "William F Godoy", "manual"),
]
...
man_pages = [(master_doc, "adios2", "ADIOS2 Documentation", [author], 1)]
