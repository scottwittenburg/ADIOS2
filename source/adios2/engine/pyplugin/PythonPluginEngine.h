 ...
 *
 * PythonPluginEngine.h Support for an engine implemented in python
 *
 *  Created on: Sept 21, 2017
 *      Author: Scott Wittenburg <scott.wittenburg@kitware.com>
 */

#ifndef ADIOS2_ENGINE_PYPLUGIN_PYTHONPLUGINENGINE_H_
#define ADIOS2_ENGINE_PYPLUGIN_PYTHONPLUGINENGINE_H_
...
class PythonPluginEngine : public Engine
{

public:
    PythonPluginEngine(IO &io, const std::string &name, const OpenMode openMode,
                 MPI_Comm mpiComm);
    virtual ~PythonPluginEngine();
...
#endif /* ADIOS2_ENGINE_PYPLUGIN_PYTHONPLUGINENGINE_H_ */
